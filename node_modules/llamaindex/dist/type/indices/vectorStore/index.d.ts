import { ContextChatEngine, type ContextChatEngineOptions } from "@llamaindex/core/chat-engine";
...
export declare class VectorStoreIndex extends BaseIndex<IndexDict> {
    ...
    static fromVectorStores(vectorStores: VectorStoreByType): Promise<VectorStoreIndex>;
