...
export default function TokenDetailPage({ params }: { params: { id: string } }) {
  ...
  const proposals = [
    ...
    {
      id: "prop-3",
      title: `${params.id.toUpperCase()}03: Community Treasury Allocation Framework`,
      description:
    ...
    {
      id: "prop-4",
      title: `${params.id.toUpperCase()}04: ${params.id.toUpperCase()} Token Utility Expansion`,
      description:
    ...
    {
      id: "prop-5",
      title: `${params.id.toUpperCase()}05: Partner with Gaming Platform`,
      description:
    ...
    {
      id: "prop-6",
      title: `${params.id.toUpperCase()}06: Tokenomics Adjustment Proposal`,
      description:
    ...
    <div className="min-h-screen bg-[#0039C6]">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-b-3xl p-6">
          {activeTab === "governance" && (
            <div>
              <div className="flex justify-between items-center mb-6">
                ...
                <Link
                  href={`/marketplace/${params.id}/create-proposal`}
          ...
          {activeTab === "feed" && (
            <TokenFeed tokenId={coin.id} tokenName={coin.name} tokenSymbol={coin.symbol} tokenLogo={coin.logo} />
          )}
          {activeTab === "trading" && (
            <TradingView
              tokenSymbol={coin.symbol}
