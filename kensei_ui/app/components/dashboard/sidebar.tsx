    ...
    <div className="h-screen bg-[#0039C6] w-64 flex-shrink-0 border-r-4 border-black">
      ...
      <div className="absolute bottom-0 w-64 p-4 border-t-4 border-black">
        <div className="space-y-4 mb-2">
          <button className="flex items-center justify-center gap-3 p-3 rounded-xl border-4 border-red-500 bg-red-500 text-white w-full hover:border-white transition-all">
            <LogOut size={20} />
