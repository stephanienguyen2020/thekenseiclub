...
import { ImageIcon, X, ChevronDown, Search, Smile, MapPin, Calendar, BarChart2 } from "lucide-react"
...
export default function PostInput({ preselectedToken = null }: { preselectedToken?: Token | null }) {
          ...
          <div className="border-t border-gray-200 mt-4 pt-4">
            <div className="flex justify-between items-center">
              <div className="flex gap-3">
                ...
                {/* GIF */}
                <button className="text-[#0046F4] hover:bg-blue-50 rounded-full p-2" title="GIF">
                ...
                {/* Emoji */}
                <button className="text-[#0046F4] hover:bg-blue-50 rounded-full p-2" title="Emoji">
                  <Smile size={20} />
                </button>

                {/* Location */}
                <button className="text-[#0046F4] hover:bg-blue-50 rounded-full p-2" title="Location">
                  <MapPin size={20} />
                </button>

                {/* Poll */}
                <button className="text-[#0046F4] hover:bg-blue-50 rounded-full p-2" title="Poll">
                  <BarChart2 size={20} />
                </button>

                {/* Schedule */}
                <button className="text-[#0046F4] hover:bg-blue-50 rounded-full p-2" title="Schedule">
                  <Calendar size={20} />
                </button>
